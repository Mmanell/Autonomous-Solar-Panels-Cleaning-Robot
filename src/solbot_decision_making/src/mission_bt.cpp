...
#include "solbot_decision_making/undock_node.hpp"
#include "solbot_decision_making/navigate_to_goal_node.hpp"
#include "solbot_decision_making/which_goal_node.hpp"
#include "solbot_decision_making/which_field_node.hpp"
#include "solbot_decision_making/clean_field_node.hpp"
#include "solbot_decision_making/planner_node.hpp"
#include "solbot_decision_making/pop_field_node.hpp"
#include "solbot_decision_making/battery_low_node.hpp"
#include "solbot_decision_making/dock_node.hpp"
...
int main(int argc, char **argv)
{
    ...
    std::string pkg_path = ament_index_cpp::get_package_share_directory("solbot_decision_making");
