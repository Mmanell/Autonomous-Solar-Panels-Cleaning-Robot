...
public:
        ...
        : Node("field_publisher")
    {
        ...
        this->declare_parameter<std::string>("fields_yaml", "src/psolar_decision_making/config/panels_fields.yaml");
        this->declare_parameter<std::string>("to_clean_yaml", "src/psolar_decision_making/config/panels_to_clean.yaml");
