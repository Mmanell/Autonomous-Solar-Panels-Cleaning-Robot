...
execute_process(
  COMMAND "/usr/bin/git" show-ref "c2d30872e20621955ca7feb9168bad996d591a19"
  WORKING_DIRECTORY "/home/manel/psolar_ws/build/fields2cover/_deps/tinyxml2-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/manel/psolar_ws/build/fields2cover/_deps/tinyxml2-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/manel/psolar_ws/build/fields2cover/_deps/tinyxml2-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
