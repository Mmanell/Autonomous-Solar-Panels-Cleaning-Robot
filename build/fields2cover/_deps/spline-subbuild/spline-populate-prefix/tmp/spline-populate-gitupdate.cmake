...
execute_process(
  COMMAND "/usr/bin/git" show-ref "1b5d4bad29082997076b264de84ca6d46c2ae6ab"
  WORKING_DIRECTORY "/home/manel/psolar_ws/build/fields2cover/_deps/spline-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/manel/psolar_ws/build/fields2cover/_deps/spline-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/manel/psolar_ws/build/fields2cover/_deps/spline-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
