...
execute_process(
  COMMAND "/usr/bin/git" show-ref "33fc010017efa1ef2c8a2d4779fcda94b4b30d20"
  WORKING_DIRECTORY "/home/manel/psolar_ws/build/fields2cover/_deps/steering_functions-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/manel/psolar_ws/build/fields2cover/_deps/steering_functions-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/manel/psolar_ws/build/fields2cover/_deps/steering_functions-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
