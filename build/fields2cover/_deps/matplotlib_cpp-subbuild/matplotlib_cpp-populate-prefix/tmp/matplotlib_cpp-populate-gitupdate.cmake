...
execute_process(
  COMMAND "/usr/bin/git" show-ref "75c15d0c907a4b68bca5ef97032302bd14ccab8e"
  WORKING_DIRECTORY "/home/manel/psolar_ws/build/fields2cover/_deps/matplotlib_cpp-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/manel/psolar_ws/build/fields2cover/_deps/matplotlib_cpp-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/manel/psolar_ws/build/fields2cover/_deps/matplotlib_cpp-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
